...
hard to reschedule. Even through to day 6 there were some days
that I woke up feeling worse than the day before.

Fortunately I seem to have no noticeable long-term effects (but we'll
talk about that below). In Japan I walked 20km in a day and went
skiing; those were both fine. I've also been to the climbing gym, but
not to judo practice yet.
...
While en-route, I've had time to write up a trip report for the first part:
...
comfortable, though the Hokkaido trains in particular (not shinkansen)
